...
namespace Handler.Interface.NetworkHandler.IP.FTP
{
    ...
    public enum FTPResponseCode
    {
             ...
             * (Server- and User-processes) have to agree on the interpretation. 
             * 
             ...
             * command form or in properties of the User or Server (e.g., the command is spelled the same with the 
             * same arguments used, 
             * 
