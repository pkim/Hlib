...
namespace Handler.NetworkHandler.Proxy
{
    ...
    public partial class ProxyDialog : Form
    {
        ...
        private Boolean serialize_Proxy()
        {
            ...
            {
                // serialize the Proxy
                XMLManager.serialize(this.proxy, typeof(Proxy), this.serialization_DirectoryPath, this.serialization_filename);
        ...
        private void deserialize_Proxy()
        {
            try
            {
                ...
                {
                    // deserialize Proxy
                    this.proxy = (Proxy)XMLManager.deserialize(typeof(Proxy), this.serialization_DirectoryPath, this.serialization_filename);
